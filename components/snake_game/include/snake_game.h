...
#define SNAKE_GO_RIGHT_BIT JOYSTICK_X4095_BIT
#define SNAKE_GO_DOWN_BIT JOYSTICK_Y4095_BIT
#define SNAKE_GO_LEFT_BIT JOYSTICK_X0_BIT
#define SNAKE_SWITCH_CONTROL_BIT BIT5
...
typedef snake_t* snake_handle_t;
